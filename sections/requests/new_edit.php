...
<?	}
	if ($NewRequest) { ?>
				<tr id="voting">
					...
					<td>
						...
						<select id="unit" name="unit" onchange="Calculate();">
							<option value="credits"<?=(!empty($_POST['unit']) && $_POST['unit'] === 'credits' ? ' selected="selected"' : '') ?>>Credits</option>
				...
				<tr>
					...
					<td>
						<input type="hidden" id="amount" name="amount" value="<?=(!empty($Bounty) ? $Bounty : '1')?>" />
