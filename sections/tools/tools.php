...
<?
    ...
    create_row("Hit & Runs", "/tools.php?action=hnr_view", check_perms("admin_hitandrun"));
...
<?
	...
	create_row("Featured Album", "tools.php?action=featured_album", check_perms("users_mod") || check_perms("site_manage_recommendations"));
