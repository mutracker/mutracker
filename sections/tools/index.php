...
switch ($_REQUEST['action']) {
	...
	case 'take_mass_pm':
		...
		break;
	case 'featured_merch':
		include(SERVER_ROOT.'/sections/tools/managers/featured_merch.php');
		break;
	case 'featured_album':
		include(SERVER_ROOT.'/sections/tools/managers/featured_album.php');
		break;
    case 'hnr_view':
		if(!check_perms('admin_hitandrun')){ error(403); }
		include(SERVER_ROOT."/sections/tools/managers/hnr_view.php");
		break;
	case 'hnr_view_ajax':
		if(!check_perms('admin_hitandrun')){ error(403); }
		include(SERVER_ROOT."/sections/tools/managers/hnr_view_ajax.php");
		break;
