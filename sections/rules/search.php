...
if (empty($_GET['nojump'])) {
	$ArticleID = Rules::alias_to_id($_GET['search']);
	if ($ArticleID) {
		//Found the article!
...
<div class="thin">
	<div class="header">
		...
		<div class="linkbox">
			<a href="rules.php?action=create&amp;alias=<?=display_str(Rules::normalize_alias($_GET['search']))?>" class="brackets">Create an article</a>
		</div>
	</div>
	<div>
