...
if ($Credits != $Cur['Credits'] && (check_perms('users_edit_ratio') || (check_perms('users_edit_own_ratio') && $UserID == $LoggedUser['ID']))) {
	$UpdateSet[] = "Credits = $Credits";
	$EditSummary[] = "Credits changed from ".$Cur['Credits']." to $Credits";
	$LightUpdates['Credits'] = $Credits;
}
