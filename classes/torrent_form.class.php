		...
		<table cellpadding="3" cellspacing="1" border="0" class="layout border" width="100%">
			<tr>
				...
				<td>
					...
					<p class="min_padding">Using the following naming format (or similar) : 
 <br/>
/Neutral Milk Hotel - In The Aeroplane Over The Sea (1998) [FLAC]/08 - Oh Comely.flac <br/> is recommended. Add the whole folder into the torrent.</p>
				</td>
			</tr>
			<tr>
...
?>
			...
			<?	if( $Torrent['LogScore'] < 1 && $Torrent['Format'] == 'FLAC') { ?>
			<tr id="upload_logs">
				<td class="label">
					Rescore Log:
				</td>
...
<? Rules::display_site_tag_rules(true); ?>
			...
			<tr>
				...
				<td>
					<p class="min_padding">Use <a href="http://yadg.cc/">yadg.cc/</a> for a consistent description style.</p>
